...
export interface IFarmingPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "setStartBlock", values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(
...
export interface IFarmingPool extends BaseContract {
  ...
  callStatic: {
    ...
    setStartBlock(_startBlock: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
