...
export interface FEtherInterface extends utils.Interface {
  functions: {
...
export interface FEther extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FEtherInterface;
  ...
  functions: {
    ...
    supply(overrides?: PayableOverrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    repayBorrowBehalf(_borrower: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    supply(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    supply(overrides?: PayableOverrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    supply(overrides?: PayableOverrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
