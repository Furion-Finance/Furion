...
export interface CoolCatsInterface extends utils.Interface {
  functions: {
    ...
    "giveAway(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "adopt", values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(
...
export interface CoolCats extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CoolCatsInterface;
  ...
  callStatic: {
    ...
    adopt(num: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    ...
    setPrice(_newPrice: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    pause(val: PromiseOrValue<boolean>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
