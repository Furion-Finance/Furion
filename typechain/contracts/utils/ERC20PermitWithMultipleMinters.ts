...
export interface ERC20PermitWithMultipleMintersInterface extends utils.Interface {
  functions: {
...
export interface ERC20PermitWithMultipleMinters extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20PermitWithMultipleMintersInterface;
